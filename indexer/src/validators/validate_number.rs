...
mod tests {
    ...
    fn test_validate_number() {
        ...
        assert_eq!(
            validate_number("abc").err(),
            Some(ValidationError::ParseFailure)
        );
        assert_eq!(
            validate_number("12.34.56").err(),
            Some(ValidationError::ParseFailure)
        );
    }
    ...
    fn test_validate_number_comprehensive() {
        ...
        // Invalid cases
        assert_eq!(
            validate_number_comprehensive("").err(),
            Some(ValidationError::EmptyInput)
        );
        assert_eq!(
            validate_number_comprehensive("abc").err(),
            Some(ValidationError::InvalidCharacters)
        );
        assert_eq!(
            validate_number_comprehensive("12.34.56").err(),
            Some(ValidationError::MultipleDecimalPoints)
        );
        assert_eq!(
            validate_number_comprehensive("1,234.56").err(),
            Some(ValidationError::InvalidCharacters)
        );
        assert_eq!(
            validate_number_comprehensive("12$34").err(),
            Some(ValidationError::InvalidCharacters)
        );
    }
    ...
    fn test_validate_integer() {
        ...
        // Invalid cases
        assert_eq!(
            validate_integer("").err(),
            Some(ValidationError::ParseFailure)
        );
        assert_eq!(
            validate_integer("abc").err(),
            Some(ValidationError::ParseFailure)
        );
        assert_eq!(
            validate_integer("12.34").err(),
            Some(ValidationError::ParseFailure)
        );
        assert_eq!(
            validate_integer("1e10").err(),
            Some(ValidationError::ParseFailure)
        );
    }
}
