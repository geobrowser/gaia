//! Example demonstrating OTLP telemetry export over gRPC.
//!
//! Use this for local collectors like Jaeger or OpenTelemetry Collector.
//!
...
//! ```
//!
//! Run with: cargo run -p hermes-instrumentation --example otlp_grpc
