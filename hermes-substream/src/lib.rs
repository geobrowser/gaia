...
// GOVERNANCE.SPACE_ID_OVERRIDDEN
//
// Emitted by SpaceRegistry.overrideSpaceId (owner-only). Carries the same
// field layout as SPACE_ID_REGISTERED — space id in `to_id`, the new owner
// address left-aligned in `topic` — but re-points an EXISTING space at a
// different address rather than creating one. Used by the migration
// transplanter (Phase 2) and by address repairs.
pub const ACTION_SPACE_ID_OVERRIDDEN: [u8; 32] = [
    0x1a, 0x73, 0xa1, 0xde, 0x82, 0x3b, 0x06, 0x92, 0xbf, 0x00, 0xfe, 0xfd, 0x1d, 0xe4, 0x0b, 0xb1,
    0x60, 0x65, 0x37, 0x07, 0x2c, 0x7a, 0x78, 0x28, 0xb4, 0x25, 0x19, 0x6e, 0x9f, 0x26, 0x00, 0x16,
];
...
// GOVERNANCE.TOPIC_SET
pub const ACTION_TOPIC_SET: [u8; 32] = [
    0x42, 0xab, 0xa2, 0xd8, 0x29, 0xb8, 0xdc, 0xd8, 0xdd, 0xf3, 0x9c, 0xc7, 0xff, 0xda, 0xf9, 0x2b,
    0x4d, 0x13, 0xcd, 0x78, 0x0f, 0xbc, 0xad, 0x6c, 0x41, 0x5a, 0xf4, 0x78, 0x0f, 0x66, 0xc7, 0x43,
];
// GOVERNANCE.TOPIC_UNSET
pub const ACTION_TOPIC_UNSET: [u8; 32] = [
    0xfe, 0x9e, 0x59, 0x54, 0xd8, 0x95, 0xf4, 0x01, 0x95, 0xe7, 0x59, 0x88, 0xb9, 0x2b, 0x48, 0xad,
    0x9f, 0x2d, 0x5c, 0x87, 0xf4, 0x36, 0x33, 0x38, 0x4b, 0x4a, 0x8f, 0x85, 0xa5, 0x3a, 0x3c, 0xf1,
];
...
// GOVERNANCE.SUBSPACE_TOPIC_SET
pub const ACTION_SUBSPACE_TOPIC_SET: [u8; 32] = [
    0x51, 0xcc, 0xa4, 0x6f, 0x19, 0x52, 0xe9, 0x70, 0xae, 0x12, 0x29, 0xcb, 0x0b, 0x58, 0xee, 0x59,
    0xa2, 0x36, 0x4a, 0xa5, 0x9c, 0xaa, 0xc7, 0x17, 0x48, 0xfe, 0xc8, 0xc9, 0x55, 0x58, 0xd6, 0xde,
];
...
// GOVERNANCE.SUBSPACE_TOPIC_UNSET
pub const ACTION_SUBSPACE_TOPIC_UNSET: [u8; 32] = [
    0x9c, 0xd6, 0x3b, 0x37, 0xc2, 0x95, 0xff, 0x0d, 0x5d, 0x21, 0xfb, 0xe1, 0x0d, 0xb5, 0x75, 0x4c,
    0x93, 0xf1, 0x2e, 0x75, 0x8b, 0xb9, 0xb0, 0x18, 0x85, 0x20, 0xde, 0xc8, 0xa2, 0x98, 0xac, 0x5f,
];
...
// The stance triple (Agree / Disagree / clear). Same topic and data encoding as
// the curation triple above — the action hash is the only kind discriminator.
// PERMISSIONLESS.AGREED
pub const ACTION_AGREED: [u8; 32] = [
    0xcc, 0x1f, 0x10, 0x4e, 0x08, 0x9f, 0xb9, 0x6a, 0xd3, 0xa3, 0xf1, 0xe7, 0x06, 0x07, 0xf3, 0xdd,
    0xa4, 0xed, 0x55, 0x6e, 0x81, 0x0b, 0xdc, 0x30, 0x19, 0x3f, 0x19, 0xdf, 0x47, 0x43, 0x69, 0xb9,
];
// PERMISSIONLESS.DISAGREED
pub const ACTION_DISAGREED: [u8; 32] = [
    0x28, 0x5c, 0x96, 0xf1, 0xd9, 0xb8, 0xf9, 0x14, 0x3d, 0x33, 0x3a, 0x76, 0x2c, 0xb9, 0xfa, 0x03,
    0xe9, 0x8b, 0x3f, 0x55, 0x1a, 0x82, 0x4e, 0x99, 0xed, 0x14, 0x07, 0x2c, 0xa3, 0xc5, 0x11, 0x79,
];
// PERMISSIONLESS.UNAGREED
pub const ACTION_UNAGREED: [u8; 32] = [
    0xa1, 0xd2, 0xa6, 0x3f, 0x41, 0x72, 0xef, 0x63, 0x61, 0x7e, 0x69, 0xca, 0x00, 0xa8, 0xa5, 0xe0,
    0xe0, 0xf8, 0x86, 0xfc, 0xd2, 0x6d, 0x74, 0x22, 0x08, 0xcc, 0x5d, 0xa0, 0x2f, 0xe3, 0x23, 0x28,
];
// The veracity triple (Verify / Dispute / clear). "PERMISSIONLESS.VERIFIED" is a
// user asserting a claim is true — unrelated to GOVERNANCE.SUBSPACE_VERIFIED
// above and to `relations.verified`. The prefix is what keeps them distinct.
// PERMISSIONLESS.VERIFIED
pub const ACTION_VERIFIED: [u8; 32] = [
    0x58, 0x84, 0x46, 0xc2, 0x95, 0x05, 0xd6, 0x9d, 0x73, 0xcb, 0xa2, 0xf3, 0x4a, 0xa4, 0x02, 0x44,
    0x7b, 0x77, 0xf0, 0x55, 0x53, 0x9a, 0x93, 0xae, 0xc8, 0x91, 0xbe, 0xb3, 0xfb, 0xf3, 0xf0, 0xfd,
];
// PERMISSIONLESS.DISPUTED
pub const ACTION_DISPUTED: [u8; 32] = [
    0x83, 0x9d, 0x07, 0x4b, 0xf1, 0x85, 0x42, 0x55, 0xcd, 0xa5, 0xc3, 0x5a, 0x5c, 0x89, 0xfe, 0xb5,
    0x68, 0x7d, 0xb0, 0x41, 0xc8, 0xff, 0x22, 0x37, 0x0e, 0x85, 0x97, 0xa5, 0x8e, 0xf7, 0x70, 0x6d,
];
// PERMISSIONLESS.UNVERIFIED
pub const ACTION_UNVERIFIED: [u8; 32] = [
    0x95, 0x16, 0xe4, 0x8c, 0x1d, 0x61, 0x49, 0x10, 0x09, 0x8d, 0xd6, 0x19, 0x78, 0x89, 0xf5, 0x4c,
    0xb0, 0x84, 0x74, 0xc6, 0x30, 0xef, 0xdb, 0x4c, 0xd0, 0x7b, 0xbe, 0xee, 0x32, 0x99, 0x12, 0xc2,
];
...
pub const ACTION_VOTING_SETTINGS_UPDATED: [u8; 32] = [
    0x91, 0xa3, 0x72, 0xef, 0xe0, 0xa0, 0x25, 0x7f, 0xd7, 0x5f, 0x60, 0x15, 0xfb, 0x9b, 0xfd, 0x32,
    0x51, 0x3b, 0xbb, 0xe8, 0x64, 0x8a, 0xa8, 0x56, 0x0d, 0xba, 0xe5, 0x9c, 0x21, 0x0a, 0x8e, 0x8f,
];
// GOVERNANCE.SPACE_ID_ARCHIVED
pub const ACTION_SPACE_ID_ARCHIVED: [u8; 32] = [
    0xfe, 0xeb, 0xc9, 0x5b, 0xdb, 0x98, 0xe0, 0x22, 0xb1, 0xd7, 0x82, 0x25, 0x59, 0xee, 0x5b, 0x0c,
    0xa1, 0x8a, 0x4e, 0x97, 0x84, 0x45, 0x9f, 0x8e, 0xfe, 0x60, 0x2e, 0xc8, 0x5c, 0x4f, 0x8e, 0x6e,
];
// GOVERNANCE.SPACE_ID_RECOVERED
pub const ACTION_SPACE_ID_RECOVERED: [u8; 32] = [
    0xe9, 0xe1, 0x16, 0xcb, 0x9e, 0x14, 0xeb, 0x72, 0xbd, 0xe5, 0x65, 0x20, 0xc8, 0xf7, 0x4d, 0xaa,
    0x85, 0xfd, 0x9d, 0x73, 0x5b, 0x8c, 0xd1, 0x23, 0xcc, 0x8d, 0xec, 0xa7, 0xfb, 0x08, 0x42, 0x4c,
];
...
fn map_topics_declared(
    ...
    let topics: Vec<TopicDeclared> = block
        .logs()
        .filter_map(|log| parse_action(log))
        .filter(|action| action.action.as_slice() == ACTION_TOPIC_SET)
...
fn map_subspaces_topic_declared(
    ...
    let declarations: Vec<SubspaceTopicDeclared> = block
        .logs()
        .filter_map(|log| parse_action(log))
        .filter(|action| action.action.as_slice() == ACTION_SUBSPACE_TOPIC_SET)
