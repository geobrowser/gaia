...
const ACTION_SPACE_ID_REGISTERED: [u8; 32] = [
...
const ACTION_SPACE_ID_MIGRATED: [u8; 32] = [
...
const ACTION_PROPOSAL_CREATED: [u8; 32] = [
...
const ACTION_PROPOSAL_VOTED: [u8; 32] = [
...
const ACTION_PROPOSAL_EXECUTED: [u8; 32] = [
...
const ACTION_EDITOR_ADDED: [u8; 32] = [
...
const ACTION_EDITOR_REMOVED: [u8; 32] = [
...
const ACTION_MEMBER_ADDED: [u8; 32] = [
...
const ACTION_MEMBER_REMOVED: [u8; 32] = [
...
const ACTION_EDITOR_FLAGGED: [u8; 32] = [
...
const ACTION_EDITOR_UNFLAGGED: [u8; 32] = [
...
const ACTION_TOPIC_DECLARED: [u8; 32] = [
...
const ACTION_EDITS_PUBLISHED: [u8; 32] = [
...
const ACTION_SUBSPACE_REMOVED: [u8; 32] = [
...
const ACTION_SUBSPACE_VERIFIED: [u8; 32] = [
...
const ACTION_SUBSPACE_RELATED: [u8; 32] = [
...
const ACTION_SUBSPACE_TOPIC_DECLARED: [u8; 32] = [
