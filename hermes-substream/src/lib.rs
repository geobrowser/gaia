...
const ACTION_UNFLAGGED: [u8; 32] = [0xf0, 0xa4, 0x01, 0x28, 0xeb, 0xa9, 0x02, 0x1d, 0x61, 0xfe, 0x51, 0xab, 0xaf, 0xc4, 0xd9, 0x73, 0x57, 0x8a, 0x60, 0xf1, 0xb2, 0x1a, 0x0b, 0xc8, 0x4e, 0x04, 0x3d, 0x71, 0x5f, 0x4a, 0xb9, 0x79];
...
const ACTION_SUBSPACE_VERIFIED: [u8; 32] = [0xf7, 0x84, 0x31, 0xed, 0xee, 0x20, 0xf4, 0xed, 0xc4, 0x76, 0x6f, 0x7e, 0x4c, 0xd7, 0xee, 0x37, 0xbf, 0x3d, 0x84, 0x51, 0x4d, 0x93, 0xd8, 0xff, 0x7e, 0x8d, 0x8b, 0x32, 0xdc, 0x8c, 0xcd, 0x39];
// GOVERNANCE.SUBSPACE_RELATED
const ACTION_SUBSPACE_RELATED: [u8; 32] = [0xe1, 0xdf, 0xc5, 0x9a, 0x5f, 0xfb, 0x61, 0x92, 0xbe, 0x6b, 0xd8, 0x24, 0x57, 0xa4, 0x8b, 0x1b, 0x67, 0x5f, 0x4f, 0xf2, 0x88, 0x6a, 0x6c, 0x14, 0x71, 0xf5, 0xc4, 0x76, 0x31, 0x44, 0x8d, 0xe5];
// GOVERNANCE.SUBSPACE_TOPIC_DECLARED
const ACTION_SUBSPACE_TOPIC_DECLARED: [u8; 32] = [0xf4, 0x75, 0x12, 0x19, 0x47, 0x61, 0x2f, 0x07, 0xc1, 0x38, 0xe5, 0xac, 0x27, 0xaa, 0x31, 0x35, 0x5a, 0xae, 0xa0, 0xda, 0x30, 0x96, 0xce, 0xa1, 0xb7, 0x02, 0xda, 0xeb, 0x5e, 0x84, 0x77, 0xaa];
// PERMISSIONLESS.UPVOTED
const ACTION_UPVOTED: [u8; 32] = [0x1f, 0xc0, 0x4a, 0x8d, 0x93, 0x87, 0xc7, 0xbd, 0x11, 0x99, 0xa2, 0xa7, 0x7c, 0x8e, 0x53, 0x1a, 0x7a, 0x7b, 0x11, 0x99, 0x1d, 0xf5, 0xdc, 0xc8, 0xc9, 0xac, 0xb6, 0xab, 0xcb, 0x48, 0x17, 0x25];
// PERMISSIONLESS.DOWNVOTED
const ACTION_DOWNVOTED: [u8; 32] = [0xde, 0x8b, 0x89, 0x7c, 0xe7, 0xcc, 0x54, 0x1d, 0xac, 0xb3, 0x88, 0xd5, 0xaa, 0xbb, 0x3d, 0xc0, 0xfb, 0x78, 0x56, 0x92, 0x02, 0x84, 0xf4, 0x15, 0x82, 0xc1, 0x5b, 0x5f, 0xc3, 0x1a, 0x86, 0x62];
// PERMISSIONLESS.UNVOTED
const ACTION_UNVOTED: [u8; 32] = [0x3b, 0xd4, 0xc3, 0x37, 0x38, 0x2f, 0x79, 0xaa, 0x50, 0x07, 0xa9, 0x11, 0x69, 0xbb, 0x57, 0x72, 0x3b, 0x5d, 0xd5, 0x9e, 0x6b, 0x4b, 0xb6, 0x0d, 0x20, 0x36, 0x2b, 0xcc, 0x0d, 0x9d, 0x99, 0x8b];
...
#[substreams::handlers::map]
fn map_subspaces_verified(block: eth::v2::Block) -> Result<SubspaceVerifiedList, substreams::errors::Error> {
...
#[substreams::handlers::map]
fn map_subspaces_related(block: eth::v2::Block) -> Result<SubspaceRelatedList, substreams::errors::Error> {
...
#[substreams::handlers::map]
fn map_subspaces_topic_declared(block: eth::v2::Block) -> Result<SubspaceTopicDeclaredList, substreams::errors::Error> {
