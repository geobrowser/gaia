...
**Documentation:** See [graph-diff-emission.md](../graph-diff-emission.md) for full design details and examples.
...
- [Graph Diff Emission](../../graph-diff-emission.md) - Full diff design with examples
