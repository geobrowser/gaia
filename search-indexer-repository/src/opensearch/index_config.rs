...
mod tests {
    ...
    fn test_index_settings_structure() {
        ...
        assert!(settings["mappings"]["properties"]["type_ids"].is_object());
        ...
        assert_eq!(
            settings["mappings"]["properties"]["type_relations"]["properties"]["relation_id"]["type"],
            "keyword"
        );
        assert_eq!(
            settings["mappings"]["properties"]["type_relations"]["properties"]["entity_to_id"]["type"],
            "keyword"
        );
