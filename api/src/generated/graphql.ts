...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  editor?: Resolver<Maybe<ResolversTypes['Membership']>, ParentType, ContextType, RequireFields<QueryEditorArgs, 'id'>>;
  editors?: Resolver<Array<Maybe<ResolversTypes['Membership']>>, ParentType, ContextType, RequireFields<QueryEditorsArgs, 'limit' | 'offset'>>;
  ...
  member?: Resolver<Maybe<ResolversTypes['Membership']>, ParentType, ContextType, RequireFields<QueryMemberArgs, 'id'>>;
  members?: Resolver<Array<Maybe<ResolversTypes['Membership']>>, ParentType, ContextType, RequireFields<QueryMembersArgs, 'limit' | 'offset'>>;
