...
export function computeProposalStatus(
  ...
  if (proposal.votingMode === "Fast") {
    ...
    const fastThreshold =
      proposal.threshold === 0n ? 0n : proposal.threshold - 1n;
  ...
  const isThresholdReached =
    (RATIO_BASE - threshold) * proposal.yesCount > threshold * proposal.noCount;
 ...
 */
export const getCurrentTimeSeconds = (): bigint =>
