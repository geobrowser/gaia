...
describe("GET /versioned/entities/:id", () => {
  ...
  describe("validation errors", () => {
    it("returns 400 when entityId is not a valid UUID", async () => {
      const res = await app.request(
        "/versioned/entities/not-a-uuid?editId=00000000-0000-0000-0000-000000000001",
      );
    ...
    it("returns 400 when editId is missing", async () => {
      const res = await app.request(
        "/versioned/entities/00000000-0000-0000-0000-000000000001",
      );
    ...
    it("returns 400 when editId is not a valid UUID", async () => {
      const res = await app.request(
        "/versioned/entities/00000000-0000-0000-0000-000000000001?editId=bad-id",
      );
  ...
  describe("successful responses", () => {
    it("returns entity snapshot when found", async () => {
      ...
      const res = await app.request(
        `/versioned/entities/${entityId}?editId=${editId}`,
      );
...
describe("GET /versioned/entities/:id/versions", () => {
  ...
  describe("validation errors", () => {
    ...
    it("returns 400 when limit is invalid", async () => {
      const res = await app.request(
        "/versioned/entities/00000000-0000-0000-0000-000000000001/versions?limit=-1",
      );
    ...
    it("returns 400 when offset is invalid", async () => {
      const res = await app.request(
        "/versioned/entities/00000000-0000-0000-0000-000000000001/versions?offset=-5",
      );
  ...
  describe("successful responses", () => {
    it("returns versions list with pagination", async () => {
      ...
      expect(body.versions[0].createdById).toBe(
    ...
    it("respects limit parameter", async () => {
      ...
      const res = await app.request(
        `/versioned/entities/${entityId}/versions?limit=1`,
      );
...
describe("GET /versioned/proposals/:id/diff", () => {
  ...
  describe("validation errors", () => {
    ...
    it("returns 400 when spaceId is missing", async () => {
      const res = await app.request(
        "/versioned/proposals/00000000-0000-0000-0000-000000000001/diff",
      );
  ...
  describe("not found errors", () => {
    ...
    it("returns 404 when edit blob is not cached (without leaking URI)", async () => {
      ...
      const res = await app.request(
        `/versioned/proposals/${proposalId}/diff?spaceId=${spaceId}`,
      );
    ...
    it("returns 400 when spaceId does not match proposal's space", async () => {
      ...
      const res = await app.request(
        `/versioned/proposals/${proposalId}/diff?spaceId=${wrongSpaceId}`,
      );
  ...
  describe("successful responses", () => {
    ...
    it("respects limit parameter", async () => {
      ...
      const res = await app.request(
        `/versioned/proposals/${proposalId}/diff?spaceId=${spaceId}&limit=10`,
      );
    ...
    it("accepts cursor parameter for pagination", async () => {
      ...
      const cursor = Buffer.from(JSON.stringify({ entityIndex: 10 })).toString(
        "base64",
      );
