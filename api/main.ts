...
import {
  canonicalRequestLogging,
  requestId,
} from "./src/middleware/requestLogging";
...
app.post(
  ...
  describeRoute({
    ...
    description:
      "Uploads an edit file to IPFS and returns the content identifier (CID)",
    requestBody: {
      content: {
        "multipart/form-data": {
          schema: {
            ...
            schema: {
              ...
              properties: {
                cid: {
                  type: "string",
                  description:
                    "The IPFS content identifier (CID) of the uploaded file",
                },
              },
              required: ["cid"],
            },
      ...
      components: {
        schemas: {
          ...
          VersionedValue: {
            type: "object",
            description:
              "A value at a specific version. Only one value field will be set.",
            properties: {
