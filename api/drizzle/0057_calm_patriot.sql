CREATE TABLE "proposal_versions" (
	...
	"partial_percentage_support_threshold" bigint,
	"universal_percentage_support_threshold" bigint,
	"flat_support_threshold" bigint,
	"execute_by" bigint,
	"executed_at" bigint,
	"name" text,
...
ALTER TABLE "proposals" DROP COLUMN "executed_at";--> statement-breakpoint
