...
impl Storage {
    ...
    pub async fn insert_values(
        ...
        let mut time_utc_values: Vec<Option<NaiveTime>> = Vec::with_capacity(values.len());
        let mut datetime_utc_values: Vec<Option<DateTime<Utc>>> = Vec::with_capacity(values.len());
        ...
        for prop in values {
            ...
            time_utc_values.push(prop.time_utc);
            datetime_utc_values.push(prop.datetime_utc);
        }
    ...
    pub async fn insert_value_versions(
        ...
        let mut time_utcs: Vec<Option<NaiveTime>> = Vec::with_capacity(set_values.len());
        let mut datetime_utcs: Vec<Option<DateTime<Utc>>> = Vec::with_capacity(set_values.len());
        ...
        for v in &set_values {
            ...
            time_utcs.push(v.time_utc);
            datetime_utcs.push(v.datetime_utc);
        }
