...
pub struct ImportCsvColumnMetadata {
    #[prost(string, tag="1")]
    pub id: ::prost::alloc::string::String,
    #[prost(enumeration="import_csv_column_metadata::CsvMetadataColumnType", tag="2")]
    pub r#type: i32,
...
pub mod import_csv_column_metadata {
    ...
    impl CsvMetadataColumnType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                CsvMetadataColumnType::Unknown => "UNKNOWN",
                CsvMetadataColumnType::Text => "TEXT",
                CsvMetadataColumnType::Number => "NUMBER",
                CsvMetadataColumnType::Checkbox => "CHECKBOX",
                CsvMetadataColumnType::Url => "URL",
                CsvMetadataColumnType::Time => "TIME",
                CsvMetadataColumnType::Point => "POINT",
                CsvMetadataColumnType::Relation => "RELATION",
            }
        }
